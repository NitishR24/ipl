...
public class rm1 extends javax.swing.JFrame {

    /**
     * Creates new form rm1
     */
    public rm1() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rm1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
