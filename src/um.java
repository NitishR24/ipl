...
public class um extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                t3.setText(r);
                t=Integer.toString(rs.getInt(3));
                t4.setText(Integer.toString(rs.getInt(3)));
                rs.next();
                f=Integer.toString(rs.getInt(3));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            int r=st.executeUpdate(" update match set mloc='"+b+"',mdate='"+c+"' where mid='"+a+"' ");
            r= st1.executeUpdate("update play set tid='"+d+"' where mid='"+a+"' and tid='"+t+"'");
             r= st1.executeUpdate("update play set tid='"+e1+"' where mid='"+a+"' and tid='"+f+"'");
            con.commit();
            jLabel4.setText("MATCH INFORMATION UPDATED SUCCESSFULLY");
        }
        catch(SQLDataException e)
            {
                System.out.println(e);jLabel4.setText("PLEASE ENTER DATE IN 'dd-mmm-yy' FORMAT");
            }
        catch(SQLIntegrityConstraintViolationException e)
        {
            System.out.println(e); jLabel4.setText("EITHER TEAM 1 ID OR TEAM 2 ID DOES NOT EXISTS");
        }
        catch(SQLException e)
        {
            System.err.println(e);
            jLabel4.setText(" ENTER THE CORRECT MATCH DETAILS");
        }
