 ...
 * @author nitsh
 */
public class rt2 extends javax.swing.JFrame {

    /**
     * Creates new form rt2
     */
    public rt2() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TEAM INFORMATION IS TO BE RETRIEVED OR DISPLAYED :");
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
        ...
        if(rcid1.isSelected()==true && rasc.isSelected()==true)
        {
            try{
                ...
                ResultSet rs=st.executeQuery("select * from team order by tid desc");
                if(rs.next()==false)
                {
            ...
            try{
                Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","NitishR","dbms");
                Statement st= con.createStatement();
                ResultSet rs=st.executeQuery("select * from team order by tname desc");
                if(rs.next()==false)
                {
                    set.setText("NO RECORDS FOUND");
                }
            ...
            try{
                Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","NitishR","dbms");
                Statement st= con.createStatement();
                ResultSet rs=st.executeQuery("select * from team order by tid ");
                if(rs.next()==false)
                {
                    set.setText("NO RECORDS FOUND");
                }
            ...
            try{
                Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","NitishR","dbms");
                Statement st= con.createStatement();
                ResultSet rs=st.executeQuery("select * from team order by tname ");
                if(rs.next()==false)
                {
                    set.setText("NO RECORDS FOUND");
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rt2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
