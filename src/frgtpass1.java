...
public class frgtpass1 extends javax.swing.JFrame {

    /**
     * Creates new form frgtpass1
     */
    public frgtpass1() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CREATE A NEW PASSWORD FOR EXISTING USER :");
...
static String s11;
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        if((u.isEmpty()== true &&m.isEmpty()==true)||(u.isEmpty()==true || m.isEmpty()==true))
        {
            ...
            try
            {
                String s= "select * from user1 where userid='"+u+"' and phone_no='"+m+"'";
                Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","NitishR","dbms");
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        if((u.isEmpty()== true &&m.isEmpty()==true)||(u.isEmpty()==true || m.isEmpty()==true))
        {
            ...
            if(u.contains(m))
            {
                try
                {
                    String s= "update user1 set pwd='"+u+"'where userid='"+s11+"'";
                    Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","NitishR","dbms");
                    Statement st= con.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frgtpass1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
